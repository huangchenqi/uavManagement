#ifndef AMMOLAUNCHWAYDAO_H
#define AMMOLAUNCHWAYDAO_H
#include <QObject>
#include <QJsonArray>
...
class AmmoLaunchWayDao:public QObject
{
    Q_OBJECT
public:
    AmmoLaunchWayDao(QObject* parent = nullptr);// explicit UavMountLocationDao(QObject *parent = 0);
