...
Rectangle {
                   ...
                   ColumnLayout {
                       ...
                       RowLayout {
                           ...
                           Item {
                               ...
                               // 显示10个字段
                               property var horHeader: ["","序号", "投弹方式"]
                       ...
                       RowLayout {
                           ...
                           Button {
                               ...
                               text: "返回"
                               onClicked: {
                                   addUavModelBombingMethodPopup.close()// 或myPopup.visible = false
           ...
           function saveUavComponentData(){
               ...
               if(uavComponeData.uavComponeName.length  === 0){
                   ...
                   let insertResult = uavBombingMethodDaoModel.insertUavModelBombingMethodDate(uavComponeData)
           ...
           function deleteUavComponentData(){
               ...
               if(sum === tableModel.rowCount){
                   warningItem.text = "投弹数据不能全部删除!"
                   warningPopup.open()
                   // 2秒后自动关闭
                   autoCloseTimer.start()
               }else{
                   let result = uavBombingMethodDaoModel.deleteUavModelBombingMethodDate(selectedRowsData)
                   recieveUavComponentAllData()
                   if(result === true){
           ...
           function updateUavComponentData(){
               ...
               let result = uavBombingMethodDaoModel.updateUavModelBombingMethodDate(resultData)
               recieveUavComponentAllData()
               if(result === true){
