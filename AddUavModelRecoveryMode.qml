...
Rectangle {
                   ...
                   ColumnLayout {
                       ...
                       RowLayout {
                           ...
                           Item {
                               ...
                               // 显示10个字段
                               property var horHeader: ["","序号", "回收方式"]
                       ...
                       RowLayout {
                           ...
                           Button {
                               ...
                               text: "返回"
                               onClicked: {
                                   addUavModelRecoveryModePopup.close()// 或myPopup.visible = false
           ...
           function saveUavComponentData(){
               ...
               if(uavComponeData.uavComponeName.length  === 0){
                   ...
                   let insertResult = uavModelRecoveryModeDaoModel.insertModelRecoveryModeDate(uavComponeData)
           ...
           function recieveUavComponentAllData (){
                       var receiveData = uavModelRecoveryModeDaoModel.selectModelRecoveryModeAllData()
           ...
           function updateUavComponentData(){
               ...
               let result = uavModelRecoveryModeDaoModel.updateModelRecoveryModeDate(resultData)
               recieveUavComponentAllData()
               if(result === true){
