...
#pragma once
#pragma db object schema("uav_type_man") table("uav_model_bombingmethod") // 指定表名
...
#pragma db not_null column("bombingmethod_id")                        // 无人机编号
    std::string bombingMethodId_;
#pragma db column("bombingmethod_name")                      // 无人机名称
