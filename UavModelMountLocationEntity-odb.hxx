...
#ifndef UAV_MODEL_MOUNT_LOCATION_ENTITY_ODB_HXX
#define UAV_MODEL_MOUNT_LOCATION_ENTITY_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::UavModelMountLocationEntity >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::UavModelMountLocationEntity >
  {
    public:
    typedef ::UavModelMountLocationEntity object_type;
    typedef ::UavModelMountLocationEntity* pointer_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct query_columns< ::UavModelMountLocationEntity, id_pgsql, A >
  {
    // id
    //
    typedef
  ...
  template <typename A>
  const typename query_columns< ::UavModelMountLocationEntity, id_pgsql, A >::id_type_
  query_columns< ::UavModelMountLocationEntity, id_pgsql, A >::
  id (A::table_name, "\"id\"", 0);

  template <typename A>
  const typename query_columns< ::UavModelMountLocationEntity, id_pgsql, A >::mountLocationId_type_
  query_columns< ::UavModelMountLocationEntity, id_pgsql, A >::
  mountLocationId (A::table_name, "\"mountlocation_code\"", 0);
  ...
  template <>
  class access::object_traits_impl< ::UavModelMountLocationEntity, id_pgsql >:
    public access::object_traits< ::UavModelMountLocationEntity >
  {
    public:
  ...
  template <>
  class access::object_traits_impl< ::UavModelMountLocationEntity, id_common >:
    public access::object_traits_impl< ::UavModelMountLocationEntity, id_pgsql >
  {
  };
...
#include "UavModelMountLocationEntity-odb.ixx"

#include <odb/post.hxx>

#endif // UAV_MODEL_MOUNT_LOCATION_ENTITY_ODB_HXX
