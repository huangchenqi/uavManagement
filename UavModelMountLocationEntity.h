...
#pragma once
#pragma db object schema("uav_type_man") table("uav_model_location") // 指定表名
...
#pragma db not_null column("mount_location_id")                        // 挂载位置编号
    std::string mountLocationId_;
#pragma db column("mountlocation_name")                      // 挂载位置名称
