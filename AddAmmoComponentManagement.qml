...
//Window {
Rectangle {
           id: addAmmoComponentManagementroot
           visible: true
           color: "#ECF2FE"
           // 暴露接口给父组件
           ...
           onManagementTypeChanged: {
               ...
               //console.log("ammoReceivemanagementType:", managementType)
           ...
           AmmoAttackTargetDaoTableModel{
               id:ammoAttackTargetDaoTableModel
           }
           ...
           TableModel {
              ...
              TableModelColumn { display: "ammoComponeName" }   // 内容
              //TableModelColumn { display: "uavComponeCode" }    // 位置编号
                   ...
                   ColumnLayout {
                       ...
                       RowLayout {
                           Layout.minimumWidth: addAmmoComponentManagementroot.width
                           Layout.minimumHeight: addAmmoComponentManagementroot.height-320
                           Layout.fillHeight: true
                           Layout.fillWidth: true
...
//                                  return "打击目标类型:"
                       ...
                       RowLayout {
                           Layout.minimumWidth: addAmmoComponentManagementroot.width
                           Layout.minimumHeight: addAmmoComponentManagementroot.height-280
                           Layout.fillHeight: true
                           Layout.fillWidth: true
                           Item {
                               id: control
                               Layout.topMargin: 2
                               implicitHeight: addAmmoComponentManagementroot.width
                               implicitWidth: addAmmoComponentManagementroot.height-280
                               Layout.fillWidth: true
                               Layout.fillHeight: true
                               //表头行高
                               ...
                               // 显示10个字段
                               property var horHeader: ["","序号", title] //["","序号", "载荷类型"]
                                             ...
                                             delegate: Rectangle {
                                                 ...
                                                 TextField {
                                                     ...
                                                     onEditingFinished:{
                                                         ...
                                                         resultData[rowIndex].ammoComponeName = text
                                                         updateAmmoAllData()
                                                     }
                                                 }
                       ...
                       RowLayout {
                           Layout.minimumWidth: addAmmoComponentManagementroot.width
                           Layout.minimumHeight: addAmmoComponentManagementroot.height-300
                           Layout.fillHeight: true
                           Layout.fillWidth: true
                           Button{
                           ...
                           Button {
                               ...
                               text: "返回"
                               onClicked: {
                                   addAmmoComponentManagementPopup.close()// 或myPopup.visible = false
           ...
           function saveUavComponentData(){
               ...
               ammoComponeData.ammoComponeCode = ""
               ammoComponeData.ammoComponeName = addAmmoComponentText.text
               // 打印当前函数的名称
                console.log("当前函数名称:", arguments.callee.name);
               console.log("addAmmoComponentText.text"+addAmmoComponentText.text)
               if(addAmmoComponentManagementroot.managementType === "killingMethod"){
                   ...
                   if(ammoComponeData.ammoComponeName.length  === 0){
                       ...
                       let insertResult = ammoKillingWayDaoTableModel.insertAmmoKillingWayData(ammoComponeData)
                  ...
                  //return "打击目标类型:"
                   ...
                   if(ammoComponeData.ammoComponeName.length  === 0){
                       ...
                       let insertResult =   ammoLaunchWayDaoTableModel.insertAmmoLaunchWayData(ammoComponeData)
                       console.log("addMountLocationText"+insertResult)
                       if(insertResult === true){
                           warningItem.text = "数据添加成功!"
                           warningPopup.open()
                  ...
                  return "发射方式:"
                   ...
                   addAmmoComponentManagementroot.horHeaderContext = "制导方式"
                   if(ammoComponeData.ammoComponeName.length  === 0){
                       warningItem.text = "数据不能为空!"
                       warningPopup.open()
                       // 2秒后自动关闭
                       ...
                       let insertResult = ammoGuidanceTypeDaoTableModel.insertAmmoGuidanceTypeData(ammoComponeData)
                       console.log("addMountLocationText"+insertResult)
                       if(insertResult === true){
                           warningItem.text = "数据添加成功!"
                           warningPopup.open()
                   ...
                   if(ammoComponeData.ammoComponeName.length  === 0){
                       ...
                       // let insertResult = uavModelLoadTypeDaoModel.insertUavModelLoadTypeDate(ammoComponeData)
                       // console.log("addMountLocationText"+insertResult)
                       // if(insertResult === true){
                       //     warningItem.text = "数据添加成功!"
                       //     warningPopup.open()
           ...
           function recieveAmmoComponentAllData (){
               var receiveData
               console.log("addAmmoComponentManagementroot"+addAmmoComponentManagementroot.managementType)
               if(addAmmoComponentManagementroot.managementType === "killingMethod"){
                   //addAmmoComponentManagementroot.horHeaderContext = "杀伤方式"
                 receiveData = ammoKillingWayDaoTableModel.selectAmmoKillingWayAllData()
                   ...
                   addAmmoComponentManagementroot.horHeaderContext = "发射方式"
                   receiveData = ammoLaunchWayDaoTableModel.selectAmmoLaunchWayAllData()
                   console.log("aaaaaaaaaa"+JSON.stringify(receiveData))
               }else if(addAmmoComponentManagementroot.managementType === "guidanceType"){
                   addAmmoComponentManagementroot.horHeaderContext = "制导方式"
                   receiveData = ammoGuidanceTypeDaoTableModel.selectAmmoGuidanceTypeAllData()
           ...
           function deleteUavComponentData(){
               ...
               // 打印当前函数的名称
                console.log("当前函数名称:", arguments.callee.name);
               if(addAmmoComponentManagementroot.managementType === "killingMethod"){
                   let result = ammoKillingWayDaoTableModel.deleteAmmoKillingWayData(selectedRowsData)
                   recieveAmmoComponentAllData()
                   if(result === true){
                   ...
                   addAmmoComponentManagementroot.horHeaderContext = "发射方式"
                   let result = ammoLaunchWayDaoTableModel.deleteAmmoLaunchWayData(selectedRowsData)
                   recieveAmmoComponentAllData()
                   if(result === true){
                       warningItem.text = "数据删除成功!"
                       warningPopup.open()
                   ...
                   addAmmoComponentManagementroot.horHeaderContext = "制导方式"
                   let result = ammoGuidanceTypeDaoTableModel.deleteAmmoGuidanceTypeData(selectedRowsData)
                   recieveAmmoComponentAllData()
                   if(result === true){
                       warningItem.text = "数据删除成功!"
                       warningPopup.open()
           ...
           function updateAmmoComponentData(){
               // 打印当前函数的名称
                console.log("当前函数名称:", arguments.callee.name);
                //console.log("resultData"+JSON.stringify(resultData))
               if(addAmmoComponentManagementroot.managementType === "killingMethod"){
                   //addAmmoComponentManagementroot.horHeaderContext = "杀伤方式"console.log("杀伤方式:+:", JSON.stringify(receiveData, null, 2));
                   let result = ammoKillingWayDaoTableModel.updateAmmoKillingWayData(resultData)
                   recieveAmmoComponentAllData()
                   if(result === true){
                   ...
                   addAmmoComponentManagementroot.horHeaderContext = "发射方式"
                   let result = ammoLaunchWayDaoTableModel.updateAmmoLaunchWayData(resultData)
                   recieveAmmoComponentAllData()
                   if(result === true){
                       warningItem.text = "数据更新成功!"
                       warningPopup.open()
                   ...
                   addAmmoComponentManagementroot.horHeaderContext = "制导方式"
                   let result = ammoGuidanceTypeDaoTableModel.updateAmmoGuidanceTypeData(resultData)
                   recieveAmmoComponentAllData()
                   if(result === true){
                       warningItem.text = "数据更新成功!"
                       warningPopup.open()
           ...
           function updateAmmoAllData(){ //更新数据
