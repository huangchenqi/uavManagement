...
public:
    ...
    Q_INVOKABLE QJsonObject queryMountingSchemeData(const QJsonObject &object);//查询某个条件的数据
    Q_INVOKABLE bool updateMountingSchemeData(const QJsonObject &object);//更新数据
