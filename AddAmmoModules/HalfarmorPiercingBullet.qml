...
Item {
                ...
                Item{
                    ...
                    TextInput{
                        ...
                        onTextChanged: {
                            ...
                            // }
                            ammoData.ammoCraterDiameter = textToFloat(text)
                ...
                Item{
                    ...
                    TextInput{
                        ...
                        onTextChanged: {
                            ...
                            // }
                            ammoData.ammoCraterDepth = textToFloat(text)
                            console.log("Text content changed to: " + text)
                        }
                        // onEditingFinished: {
                ...
                Item{
                    ...
                    TextInput{
                        ...
                        onTextChanged: {
                            ...
                            // }
                            ammoData.ammoDamagedArea = textToFloat(text)
                            console.log("Text content changed to: " + text)
                        }
                        // onEditingFinished: {
    ...
    function loadAllAmmoData(){
        console.log("addAmmoAllDatView.ammoSelectData.ammoCraterDiameter"+addAmmoAllDatView.ammoSelectData.ammoCraterDiameter)
    ...
    function allComponentEnable(){
        ...
        text_Input_CraterDepth.enabled = false
        text_Input_DamageArea.enabled = false
    }
}
