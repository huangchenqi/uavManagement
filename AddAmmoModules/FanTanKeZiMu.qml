                ...
                Item{
                    ...
                    TextInput{
                        ...
                        onTextChanged: {
                            ...
                            // }
                            ammoData.bullet_density_range_minimum = textToFloat(text)
                ...
                Item{
                    ...
                    TextInput{
                        ...
                        onTextChanged: {
                            ...
                            // }
                            ammoData.bullet_density_range_maximum = textToFloat(text)
                            console.log("Text content changed to: " + text)
                        }
                        // onEditingFinished: {
                ...
                Item{
                    ...
                    TextInput{
                        ...
                        onTextChanged: {
                            ...
                            // }
                            ammoData.ground_ignition_rate = textToFloat(text)
                            console.log("Text content changed to: " + text)
                        }
                        // onEditingFinished: {
