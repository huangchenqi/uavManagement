                                              ...
                                              Row {
                                                  ...
                                                  Button {
                                                      ...
                                                      onClicked: {
                                                          ...
                                                          pagePayloadLoader.setSource("qrc:./AddInterferencePodData_add.qml",//AddInterferencePodData
                                                  ...
                                                  Button {
                                                      ...
                                                      onClicked: {
                                                          ...
                                                          console.log("查看行数据InterferencePodData:", JSON.stringify(rowData, null, 2))
                                                          // 转换数据
                                                          var transformedData = transformData(rowData)
                                                          console.log("转换后的数据:", JSON.stringify(transformedData, null, 2))
