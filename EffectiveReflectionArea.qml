...
Item {
    ...
    Rectangle{
        ...
        Rectangle{
            ...
            Rectangle{
                ...
                Rectangle{
                    ...
                    border.width: 1
                    border.color: mainColor
                    width: parent.width - rect_MaxTitle.width - rect_MinTitle.width - rect_NumTitle.width
                    color: "transparent"
                    ...
                    Item {
                        ...
                        Rectangle{
                            ...
                            Rectangle{
                                ...
                                border.width: m_SelectState ? 5 : 1
                                border.color: m_SelectState ? "red" : mainColor
                                width: parent.width - rect_Max.width - rect_Min.width - rect_Num.width
                                color: "transparent"
        ...
        CButton{
            ...
            height: 36
            onClicked: {
                listmodel_.append({m_SelectState:false,m_MinData:"",m_MaxData:"",m_DescribeData:""})
            }
        }
        CButton{
            id:btn_Del
