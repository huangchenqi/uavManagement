...
//     //                                               viewType ===  "无源干扰吊舱"  ){
//     //                                              // 动态加载 QML 文件并设置属性
//     //                                              reconnaissanceCommunicationRecordLoader.setSource("qrc:./AddAmmoAllData.qml", {viewType: viewType})
//     //                                          }else{
//     //                                              // 动态加载 QML 文件并设置属性
//     //                                              reconnaissanceCommunicationRecordLoader.setSource("qrc:./AddAmmoAviationAllData.qml")
//     //                                          }
//     //                                          // 动态加载 QML 文件并设置属性
//     //                                          //reconnaissanceCommunicationRecordLoader.setSource("qrc:./AddAmmoAllData.qml", {viewType: viewType})
...
//     visible: true
//     color: "#ECF2FE"
//     width: 1400 //width: screenWidth; height: screenHeight
//     height: 760
//     // 组件加载完成后生成测试数据
//     Component.onCompleted: {
//         loadPayloadData();
...
//         TableModelColumn {
//             display: "frontCoverLength"
//         }
//         // 接装部队

//         TableModelColumn {
//             display: "rearCoverLength"
//         }
//         // 观察项内容

//         TableModelColumn {
//             display: "mainCabinSectione"
//         }
//         // 提出者ID
...
//         // 直接引用 admin.qml
//         AddAmmoComponentManagement {
//             //managementType:uavManagementroot.managementType

//             // 假设 admin.qml 的根元素是 Admin 类型
...
//                     //                                  height: 40
//                     //                                  font.pointSize: 12
//                     //                                  model:reconnaissanceCommunicationRecordManagementroot.ammoTypeSelect// ["全部","侦察无人机","攻击无人机","查打一体无人机"]
//                     //                              }
//                     //                              Label{
//                     //                                  id:guidanceWay
//                     //                                  width:100
...
//                     //列宽
//                     property variant columnWidthArr: [50, 50, 180, 180, 120, 120, 120, 120, 200, 300]
//                     // 显示10个字段
//                     property var horHeader: ["", "序号", "通信侦察名称", "频率最小值", "频率最大值", "前罩长", "后罩长", "主舱截面", "用途描述", "操作"]
...
//                                 visible: (scroll_vertical.size < 1)
...
//                             contentItem: Rectangle {
//                                 visible: (scroll_horizontal.size < 1)
