...
namespace odb
{
        ...
        bool* t)
  {
    ...
    if (t[1UL])
    {
      i.loadId_value.capacity (i.loadId_size);
      grew = true;
    }
        ...
        pgsql::statement_kind sk)
  {
    ...
    b[n].buffer = i.loadId_value.data ();
    b[n].capacity = i.loadId_value.capacity ();
    b[n].size = &i.loadId_size;
    b[n].is_null = &i.loadId_null;
    n++;
        ...
        pgsql::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.loadId_value.capacity ());
      pgsql::value_traits<
          ::std::string,
        ...
        is_null,
        v);
      i.loadId_null = is_null;
      i.loadId_size = size;
      grew = grew || (cap != i.loadId_value.capacity ());
    }
  ...
  "INSERT INTO \"public\".\"uav_model_loadtype\" "
  "(\"id\", "
  "\"load_id\", "
  "\"loadtype_name\") "
  "VALUES "
  ...
  "SELECT "
  "\"public\".\"uav_model_loadtype\".\"id\", "
  "\"public\".\"uav_model_loadtype\".\"load_id\", "
  "\"public\".\"uav_model_loadtype\".\"loadtype_name\" "
  "FROM \"public\".\"uav_model_loadtype\" "
  "WHERE \"public\".\"uav_model_loadtype\".\"id\"=$1";

  const char access::object_traits_impl< ::UavModelLoadTypeEntity, id_pgsql >::update_statement[] =
  "UPDATE \"public\".\"uav_model_loadtype\" "
  "SET "
  "\"load_id\"=$1, "
  "\"loadtype_name\"=$2 "
  "WHERE \"id\"=$3";
  ...
  "DELETE FROM \"public\".\"uav_model_loadtype\" "
  "WHERE \"id\"=$1";
  ...
  create_schema (database& db, unsigned short pass, bool drop)
  {
    ...
    if (drop)
    {
      switch (pass)
      {
        ...
        case 2:
        {
          db.execute ("DROP TABLE IF EXISTS \"public\".\"uav_model_loadtype\" CASCADE");
          return false;
        }
      }
    }
    else
    {
      switch (pass)
      {
        case 1:
        {
          db.execute ("CREATE TABLE \"public\".\"uav_model_loadtype\" (\n"
