        ...
        Rectangle{
            ...
            Rectangle{
                ...
                CButton{
                    ...
                    property int iMouseX: 0
                    property int iMouseY: 0
                    onEntered: {
                        if(processInfo.loadViewType !== "query")
                        {
                            isEnterd = true
                    ...
                    onExited: {
                        isEnterd = false
                        viewShow_timer_Loadammo.stop()
                        rect_Mask_Loadammo.visible = false
                    }
                    onPositionChanged: {
                        iMouseX = mouseX
                        iMouseY = mouseY
                    ...
                    Timer{
                        id:viewShow_timer_Loadammo
                        running: comp_uavLoadammo.isEnterd
                        repeat: comp_uavLoadammo.isEnterd
                        interval: 1000  //1s
                        onTriggered: {
                            var trmpText = ""
                            for(var i=0; i<listmodel_Box_uavLoadammo.count; i++)
                            {
                                ...
                                {
                                    trmpText += listmodel_Box_uavLoadammo.get(i).m_TypeName
                                    trmpText += "、"
                                }
                            }
                            console.log("showText:",trmpText)
                            show_text_Loadammo.text = trmpText.slice(0,-1)
                            rect_Mask_Loadammo.visible = true
                        }
                    }
                    Rectangle{
                        id:rect_Mask_Loadammo
                        x:comp_uavLoadammo.iMouseX
                        y:comp_uavLoadammo.iMouseY -20
                        visible: false
                        height: show_text_Loadammo.height
                        width: show_text_Loadammo.width
                        Text{
                            id:show_text_Loadammo
                            font.family: "黑体"
                            font.pixelSize: 18
                        }
                    }
                ...
                ListView{
                    ...
                    height: comp_uavLoadammo.height * 3
                ...
                CButton{
                    ...
                    onExited: {
                        isEnterd = false
                        viewShow_timer_InvestigationPayloadType.stop()
                        rect_Mask_InvestigationPayloadType.visible = false
                    }
                    onPositionChanged: {
                        iMouseX = mouseX
                        iMouseY = mouseY
                    ...
                    Timer{
                        id:viewShow_timer_InvestigationPayloadType
                        running: comp_uavInvestigationPayloadType.isEnterd
                        repeat: comp_uavInvestigationPayloadType.isEnterd
                        interval: 1000  //1s
                        onTriggered: {
                            var trmpText = ""
                            for(var i=0; i<listmodel_Box_InvestigationPayloadType.count; i++)
                            {
                                ...
                                {
                                    trmpText += listmodel_Box_InvestigationPayloadType.get(i).m_TypeName
                                    trmpText += "、"
                                }
                            }
                            show_text_InvestigationPayloadType.text = trmpText.slice(0,-1)
                            rect_Mask_InvestigationPayloadType.visible = true
                        }
                    }
                    Rectangle{
                        id:rect_Mask_InvestigationPayloadType
                        x:comp_uavInvestigationPayloadType.iMouseX
                        y:comp_uavInvestigationPayloadType.iMouseY-20
                        visible: false
                        height: show_text_InvestigationPayloadType.height
                        width: show_text_InvestigationPayloadType.width
                        Text{
                            id:show_text_InvestigationPayloadType
                            font.family: "黑体"
                            font.pixelSize: 18
                        }
                    }
                ...
                ListView{
                    ...
                    height: comp_uavInvestigationPayloadType.height * 3
                ...
                CButton{
                    ...
                    onExited: {
                        isEnterd = false
                        viewShow_timer_Bombingmethod.stop()
                        rect_Mask_Bombingmethod.visible = false
                    }
                    onPositionChanged: {
                        iMouseX = mouseX
                        iMouseY = mouseY
                    ...
                    Timer{
                        id:viewShow_timer_Bombingmethod
                        running: comp_uavBombingmethod.isEnterd
                        repeat: comp_uavBombingmethod.isEnterd
                        interval: 1000  //1s
                        onTriggered: {
                            var trmpText = ""
                            for(var i=0; i<listmodel_Box_uavBombingmethod.count; i++)
                            {
                                ...
                                {
                                    trmpText += listmodel_Box_uavBombingmethod.get(i).m_TypeName
                                    trmpText += "、"
                                }
                            }
                            show_text_Bombingmethod.text = trmpText.slice(0,-1)
                            rect_Mask_Bombingmethod.visible = true
                        }
                    }
                    Rectangle{
                        id:rect_Mask_Bombingmethod
                        x:comp_uavBombingmethod.iMouseX
                        y:comp_uavBombingmethod.iMouseY-20
                        visible: false
                        height: show_text_Bombingmethod.height
                        width: show_text_Bombingmethod.width
                        Text{
                            id:show_text_Bombingmethod
                            font.family: "黑体"
                            font.pixelSize: 18
                        }
                    }
                ...
                ListView{
                    ...
                    height: comp_uavBombingmethod.height * 3
            ...
            Rectangle{
                ...
                CButton{
                    ...
                    onExited: {
                        isEnterd = false
                        viewShow_timer_Recoverymode.stop()
                        rect_Mask_Recoverymode.visible = false
                    }
                    onPositionChanged: {
                        iMouseX = mouseX
                        iMouseY = mouseY
                    ...
                    Timer{
                        id:viewShow_timer_Recoverymode
                        running: comp_uavRecoverymode.isEnterd
                        repeat: comp_uavRecoverymode.isEnterd
                        interval: 1000  //1s
                        onTriggered: {
                            var trmpText = ""
                            for(var i=0; i<listmodel_Box_uavRecoverymode.count; i++)
                            {
                                ...
                                {
                                    trmpText += listmodel_Box_uavRecoverymode.get(i).m_TypeName
                                    trmpText += "、"
                                }
                            }
                            show_text_Recoverymode.text = trmpText.slice(0,-1)
                            rect_Mask_Recoverymode.visible = true
                        }
                    }
                    Rectangle{
                        id:rect_Mask_Recoverymode
                        x:comp_uavRecoverymode.iMouseX
                        y:comp_uavRecoverymode.iMouseY-20
                        visible: false
                        height: show_text_Recoverymode.height
                        width: show_text_Recoverymode.width
                        Text{
                            id:show_text_Recoverymode
                            font.family: "黑体"
                            font.pixelSize: 18
                        }
                    }
                ...
                ListView{
                    ...
                    height: comp_uavRecoverymode.height * 3
                ...
                CButton{
                    ...
                    onExited: {
                        isEnterd = false
                        viewShow_timer_operationMode.stop()
                        rect_Mask_operationMode.visible = false
                    }
                    onPositionChanged: {
                        iMouseX = mouseX
                        iMouseY = mouseY
                    ...
                    Timer{
                        id:viewShow_timer_operationMode
                        running: comp_operationMode.isEnterd
                        repeat: comp_operationMode.isEnterd
                        interval: 1000  //1s
                        onTriggered: {
                            var trmpText = ""
                            for(var i=0; i<listmodel_Box_operationMode.count; i++)
                            {
                                ...
                                {
                                    trmpText += listmodel_Box_operationMode.get(i).m_TypeName
                                    trmpText += "、"
                                }
                            }
                            show_text_operationMode.text = trmpText.slice(0,-1)
                            rect_Mask_operationMode.visible = true


                        }
                    }
                    Rectangle{
                        id:rect_Mask_operationMode
                        x:comp_operationMode.iMouseX
                        y:comp_operationMode.iMouseY-20
                        visible: false
                        height: show_text_operationMode.height
                        width: show_text_operationMode.width
                        Text{
                            id:show_text_operationMode
                            font.family: "黑体"
                            font.pixelSize: 18
                        }
                    }
                ...
                ListView{
                    ...
                    height: comp_operationMode.height * 3
