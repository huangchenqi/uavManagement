...
Rectangle {
           ...
           // 表格数据模型
              TableModel {
                  ...
                  TableModelColumn { display: "ammoName" }   // 机型
                  TableModelColumn { display: "ammoType" }      // 批次
                  TableModelColumn { display: "length" }    // 架次
                  TableModelColumn { display: "mass" }         // 接装部队
                  TableModelColumn { display: "diameter" } // 部队专业
                  TableModelColumn { display: "wingspan" }  // 提出者ID
                  TableModelColumn { display: "description" }  // 观察项内容
                      ...
                      ColumnLayout {
                          ...
                          RowLayout {
                              ...
                              ComboBox {
                                  ...
                                  height: 40
                                  font.pointSize: 12
                                  model:uavAmmoManagementroot.ammoTypeSelect// ["全部","侦察无人机","攻击无人机","查打一体无人机"]
                              }
                              Label{
                                  id:ammoName
                                  width:100
...
//                              }
                              Button{
                                  ...
                                  onClicked: {
                                      //inputValidator()
                                      if(ammoTypeModelSelector.currentText === "请选择:"&& ammoNameText.length === 0 ){
                                      ...
                                      var uavData = {
                                          ammoType:"请选择:",
                                          ammoName:""}
                                       uavData.ammoType = ammoTypeModelSelector.currentText
                                       uavData.ammoName = ammoNameText.text
                      ...
                      RowLayout {
                          Layout.minimumWidth: uavAmmoManagementroot.width
                          Layout.minimumHeight: uavAmmoManagementroot.height-280
                          Layout.fillHeight: true
                          Layout.fillWidth: true

                          Item {
                              id: control
                              implicitHeight: uavAmmoManagementroot.width
                              implicitWidth: uavAmmoManagementroot.height-280
                              Layout.fillWidth: true
                              Layout.fillHeight: true
                              ...
                              // 显示10个字段
                              property var horHeader: ["","序号", "弹药名称", "弹药类型", "长度", "质量",
                                  "直径", "翼展", "用途描述",  "操作"]
...
//                              }
  ...
  //                          }
                            Button {
                                id: aerodynamicConfigurationTypeManagement
                                text: "气动布局管理"
                                onClicked: {
                                    addAmmoComponentManagementPopup.setup("气动布局")
                                    addAmmoComponentManagementPanel.managementType = "aerodynamicConfigurationType"//addAmmoComponentManagementPopup.setUpAmmoCompType("attackTargetType")
                                    addAmmoComponentManagementPopup.open()
...
//                            Item { Layout.fillWidth: true }
                            ...
                            //     }
                            // }
                            Item { Layout.rightMargin: 20 }//Item { Layout.fillWidth: true }
           ...
           function deleteAmmoData(){
                   ...
                   if (selectedRowsData.length === 0) {
                       ...
                       let result = ammoDaoTableModel.deleteAmmoData(selectedRowsData)
                       var uavData = {
                              ammoType:"请选择:",
                              ammoName:""}
                       loadAmmoRecord(uavData)
